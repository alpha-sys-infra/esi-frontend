...
class MyHeader extends React.PureComponent {
	...
	render() {
		return (
			<Header
				style={{ background: '#fff', padding: 0, height: 'auto', position: 'fixed', width: '100%', zIndex: 9 }}
			>
				<Row type="flex" justify="start">
					...
					<Col xs={26} sm={22} md={12} lg={12} xl={16}>
						<ModuleMenu
					...
					<Col xs={16} sm={8} md={7} lg={6} xl={7}>
						<Menu mode="horizontal" style={{ lineHeight: '64px' }} onClick={this.menuClick}>
							<Menu.Item key="full">
								<FullScreen />
							</Menu.Item>
