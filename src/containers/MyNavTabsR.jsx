...
class MyNavTabs extends React.PureComponent {
  ...
  tabStyle={ background: 'white', width: '100%', padding: 10, margin: 0, position: 'fixed', zIndex: 99, border: 'none' };
  hasPermission = true
      ...
      <div style={this.props.style}>
        ...
        >
          {this.state.openPages.map(page => {
            ...
            return <TabPane forceRender tab={page.title} closable={page.closable} key={page.name} style={tabPaneStyle}>
              <Page />
            </TabPane>
          }
          )}
